...
#firstField {
	...
	<form name="vehicleForm" action="vehicleForm.php" method="post">
		<div id="vehicleInfo">
			<label for="vehicleType" id="firstLabel">Vehicle ID:</label> <input
				type="text" name="vehicleType" id="firstField">
			<p></p>
			<label for="vehicleSeats" id="firstLabel">Seats:</label> <input
				type="text" name="vehicleSeats" id="firstField">
			<p></p>
			<label for="vehicleColor" id="firstLabel">Vehicle Color:</label> <input
				name="vehicleColor" class="jscolor jscolor-active" id="firstField"
				value="ab2567" autocomplete="off"
				style="color: rgb(255, 255, 255); background-image: none; background-color: rgb(171, 37, 103);">
		</div>
		<div id="vehicleSave">
